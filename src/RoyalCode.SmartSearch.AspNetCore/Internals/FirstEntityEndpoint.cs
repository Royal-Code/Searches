...
public class FirstEntityEndpoint<TEntity, TFilter>
    where TEntity : class
    where TFilter : class
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="FirstEntityEndpoint{TEntity, TFilter}"/>.
    /// </summary>
    /// <param name="searchAction">Custom action to configure the search.</param>
    public FirstEntityEndpoint(Action<ICriteria<TEntity>>? searchAction = null)
    {
...
public class FirstEntityEndpoint<TEntity, TFilter, TId>
    where TEntity : class
    where TFilter : class
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="FirstEntityEndpoint{TEntity, TFilter, TId}"/>.
    /// </summary>
    /// <param name="searchAction">Custom action to configure the search with identifier.</param>
    public FirstEntityEndpoint(Action<TId, ICriteria<TEntity>>? searchAction = null)
    {
        this.searchAction = searchAction;
    }
...
public class FirstEntityEndpoint<TEntity, TFilter, TId1, TId2>
    where TEntity : class
    where TFilter : class
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="FirstEntityEndpoint{TEntity, TFilter, TId1, TId2}"/>.
    /// </summary>
    /// <param name="searchAction">Custom action to configure the search with identifiers.</param>
    public FirstEntityEndpoint(Action<TId1, TId2, ICriteria<TEntity>>? searchAction = null)
    {
        this.searchAction = searchAction;
    }
...
public class FirstEntityEndpoint<TEntity, TFilter, TId1, TId2, TId3>
    where TEntity : class
    where TFilter : class
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="FirstEntityEndpoint{TEntity, TFilter, TId1, TId2, TId3}"/>.
    /// </summary>
    /// <param name="searchAction">Custom action to configure the search with identifiers.</param>
    public FirstEntityEndpoint(Action<TId1, TId2, TId3, ICriteria<TEntity>>? searchAction = null)
    {
        this.searchAction = searchAction;
    }
